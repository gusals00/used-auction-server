...
class ErrorCodeTest {
    ...
    void ResultResTest() throws Exception{
        ...
        Assertions.assertThat(fileErrorResponseEntity.getBody().getMessage()).isEqualTo(fileNotFound.getMessage());
        ...
        Assertions.assertThat(s3ErrorResponseEntity.getBody().getMessage()).isEqualTo(s3FileNotFound.getMessage());
        ...
        Assertions.assertThat(userrrorResponseEntity.getBody().getMessage()).isEqualTo(userNotFound.getMessage());
